...
# 2 — Comandos esenciales del día a día
...
## 2.1 /compact — Limpiar el historial
...
## 3.1 /resume — Historial de conversaciones
...
## 3.2 /rename — Renombrar conversación
...
## 3.3 /branch — Crear una rama de la conversación
...
## 3.4 /Rewind — Restaura el código y/o conversación a un punto anterior
...
## 3.5 /Export — Exporta la conversación actual a un archivo o portapapeles
...
## 3.6 /Desktop — Continúa la sesión actual en Claude Desktop
...
## 3.7 /Teleport — Retoma una sesión de Claude Code desde claude.ai
